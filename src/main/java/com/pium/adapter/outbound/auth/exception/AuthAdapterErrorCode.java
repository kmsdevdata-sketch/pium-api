...
public enum AuthAdapterErrorCode implements ErrorCode {
    ...
    KAKAO_TOKEN_EXCHANGE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH_ADAPTER_500_005", "카카오 액세스 토큰 교환에 실패했습니다."),
    KAKAO_USER_LOAD_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH_ADAPTER_500_006", "카카오에서 사용자 정보를 조회하는데 실패했습니다.");
